...
@section('breadcrumb')
    ...
    <li class=" breadcrumb-item">
        <a href="{{ route('produtos.show', $produto->id) }}">Detalhes de Produto </a>
    </li>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/produtos') }}" title="Back"><button class="btn btn-warning btn-sm"><i
                                    class="fa fa-arrow-left" aria-hidden="true"></i> Voltar</button></a>
                        <a href="{{ url('/produtos/' . $produto->id . '/edit') }}" title="Edit Produto"><button
                                class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                Atualizar</button></a>

                        <form method="POST" action="{{ url('produtos' . '/' . $produto->id) }}" accept-charset="UTF-8"
